 ...
 * @author sherzod
 */
public class ResourceTemplate extends AbstractTemplate<AnnotatedDocument, State, StateFactorScope<State>> {

    private Set<String> validPOSTags;
    private Map<Integer, String> semanticTypes;

    public ResourceTemplate(Set<String> validPOSTags, Map<Integer, String> semanticTypes) {
...
//
//            if (!headDUDEName.equals("Individual")) {
//                continue;
//            }
//
//            if (headURI.equals("EMPTY_STRING")) {
...
//
//            //lexical feature
//            if (semanticTypes.get(headDUDEID).equals("Individual") && headPOS.startsWith("NN")) {
//                featureVector.addToValue("RESOURCE LEXICAL FEATURE: URI: " + headURI + " TOKEN: " + headToken + " POS : " + headPOS + " SEMANTIC TYPE: Individual", 1.0);
////                featureVector.addToValue("RESOURCE FEATURE: POS : " + headPOS + " SEMANTIC TYPE: Individual", 1.0);
//            }
//
//
//            List<Integer> dependentNodes = state.getDocument().getParse().getDependentEdges(tokenID);
...
//                    }
//
//                    featureVector.addToValue("RESOURCE LEXICAL DEP FEATURE: HEAD_TOKEN: " +headToken + " HEAD_URI: " + headURI + " CHILD_TOKEN: " + depToken + " CHILD_URI: " + depURI + " CHILD-SEM-TYPE: "+depDUDEName +" DEP-RELATION: "+depRelation + " HEAD-SEM-TYPE: "+headDUDEName + " CHILD-SEM-TYPE: "+depDUDEName, 1.0);
//                }
//            }
//        }
    }
